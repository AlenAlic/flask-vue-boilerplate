...
export default {
  data() {
    return {
      types: {
        info: { itemClass: "alert--info", iconClass: "alert_icon fas fa-info-circle" },
        error: { itemClass: "alert--error", iconClass: "alert_icon fas fa-info-circle" },
        warning: {
          itemClass: "alert--warning",
          iconClass: "alert_icon fas fa-exclamation-triangle"
        },
        success: {
          itemClass: "alert--success",
          iconClass: "alert_icon fas fa-check-circle"
        }
      },
      options: {
